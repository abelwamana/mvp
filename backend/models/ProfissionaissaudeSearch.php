...
/**
 * ProfissionaissaudeSearch represents the model behind the search form of `backend\models\Profissionaissaude`.
 */
class ProfissionaissaudeSearch extends Profissionaissaude
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'NTotHoras' => $this->NTotHoras,
            'NSessoes' => $this->NSessoes,
            'NSessoesTrimestre' => $this->NSessoesTrimestre,
            'ParticipantesTrimHomem' => $this->ParticipantesTrimHomem,
            'ParticipantesTrimMulher' => $this->ParticipantesTrimMulher,
        ...
        $query->andFilterWhere(['like', 'nomeFormacao', $this->nomeFormacao])

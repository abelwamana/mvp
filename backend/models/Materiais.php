 ...
 * @property string|null $entidadeRecebeuEntPub
 * @property string|null $equipamentoEntregue
 * @property int|null $qtdEquipEntregues
 * @property int|null $nFitaMUACmenor5anos
 * @property int|null $nFitaMUACmulherGravida
 * @property int|null $fitasPerCefalico
 * @property int|null $balancaPediatrica
 * @property int|null $balancaAdultas
 * @property int|null $altimetro
...
class Materiais extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['provinciaID', 'municipioID', 'comunaID', 'localidadeID', 'qtdEquipEntregues', 'nFitaMUACmenor5anos', 'nFitaMUACmulherGravida', 'fitasPerCefalico', 'balancaPediatrica', 'balancaAdultas', 'altimetro', 'userID'], 'integer'],
            [['primeiroReporte', 'actualizacao', 'dataVisitaFresan', 'createdAt', 'UpdatedAt'], 'safe'],
            [['desafiosImplementacaoONG', 'licoesImplementacaoONG', 'recomendacoesPrincipaisFresan', 'estadoValidacao'], 'string'],
            [['entidadeRecebeuEntPub', 'entidade', 'medidasMitigacaoEstado'], 'string', 'max' => 50],
            [['equipamentoEntregue', 'respondente', 'latitude', 'longitude', 'constatacoesFeitasFresan', 'medidasMitigacaoONG'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'entidadeRecebeuEntPub' => Yii::t('app', 'Entidade Recebeu Ent. Pub.'),
            'equipamentoEntregue' => Yii::t('app', 'Equipamento Entregue'),
            'qtdEquipEntregues' => Yii::t('app', 'Qtd Equip Entregues'),
            'nFitaMUACmenor5anos' => Yii::t('app', 'N Fita Mua Cmenor5anos'),
            'nFitaMUACmulherGravida' => Yii::t('app', 'N Fita Mua Cmulher Gravida'),
            'fitasPerCefalico' => Yii::t('app', 'Fitas Per Cefalico'),
            'balancaPediatrica' => Yii::t('app', 'Balanca Pediatrica'),
            'balancaAdultas' => Yii::t('app', 'Balanca Adultas'),
            'altimetro' => Yii::t('app', 'Altimetro'),

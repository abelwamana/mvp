...
/**
 * This is the model class for table "suplementacao".
 *
 * @property int $Id
 ...
 * @property int|null $nSuplemVit
 * @property string|null $nSuplemViTrimestre
 * @property int|null $nDesparatizacao
 * @property string|null $nDesparatizacaoTrimestre
 ...
 */
class Suplementacao extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['provinciaID', 'municipioID', 'comunaID', 'localidadeID', 'nSuplemVit', 'nDesparatizacao', 'userID'], 'integer'],
            [['nSuplemViTrimestre', 'nDesparatizacaoTrimestre', 'primeiroReporte', 'actualizacao', 'dataVisitaFresan', 'createdAt', 'UpdatedAt'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'nSuplemVit' => Yii::t('app', 'Nº Suplem Vit'),
            'nSuplemViTrimestre' => Yii::t('app', 'N Suplem Vi Trimestre'),
            'nDesparatizacao' => Yii::t('app', 'N Desparatizacao'),
            'nDesparatizacaoTrimestre' => Yii::t('app', 'N Desparatizacao Trimestre'),

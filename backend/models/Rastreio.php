...
/**
 * This is the model class for table "rastreio".
 *
 * @property int $Id
 ...
 * @property int|null $DAS
 * @property int|null $DAM
 * @property int|null $EDEMA
 * @property int|null $Saudavel
 * @property int|null $trimestre
 * @property string|null $anexo
 * @property int|null $beneficiarioCriaGrav
 ...
 */
class Rastreio extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['provinciaID', 'municipioID', 'comunaID', 'localidadeID', 'DAS', 'DAM', 'EDEMA', 'Saudavel', 'beneficiarioCriaGrav', 'nomeGrupoID', 'userID'], 'integer'],
            [['primeiroReporte', 'actualizacao', 'trimestre','dataVisitaFresan', 'createdAt', 'UpdatedAt'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'Saudavel' => Yii::t('app', 'Saudavel'),
            'trimestre' => Yii::t('app', 'Trimestre'),
            'anexo' => Yii::t('app', 'Anexo'),
            'beneficiarioCriaGrav' => Yii::t('app', 'Beneficiario Cria Grav'),
            ...
            'nomeGrupoID' => Yii::t('app', 'Nome Grupo ID'),

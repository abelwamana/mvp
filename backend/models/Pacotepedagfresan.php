...
/**
 * This is the model class for table "pacotepedagfresan".
 *
 * @property int $Id
 ...
 * @property string|null $receitaMwangole
 * @property string|null $painelAlimentacao
 * @property string|null $outroManualAlimentacao
 ...
 */
class Pacotepedagfresan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['provinciaID', 'municipioID', 'comunaID', 'localidadeID', 'userID'], 'integer'],
            ...
            [['receitaMwangole', 'painelAlimentacao', 'entidade', 'medidasMitigacaoEstado'], 'string', 'max' => 50],
            [['outroManualAlimentacao', 'respondente', 'latitude', 'longitude', 'constatacoesFeitasFresan', 'medidasMitigacaoONG'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'receitaMwangole' => Yii::t('app', 'Receita Mwangole'),
            'painelAlimentacao' => Yii::t('app', 'Painel Alimentacao'),
            'outroManualAlimentacao' => Yii::t('app', 'Outro Manual Alimentacao'),

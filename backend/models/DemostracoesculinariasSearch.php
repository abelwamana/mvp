...
/**
 * DemostracoesculinariasSearch represents the model behind the search form of `backend\models\Demostracoesculinarias`.
 */
class DemostracoesculinariasSearch extends Demostracoesculinarias
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = Demostracoesculinarias::find();
        ...
        $query->andFilterWhere([
            ...
            'nDemostracaoCulinaria' => $this->nDemostracaoCulinaria,
            'nDemostracaoCulinariaTrimestre' => $this->nDemostracaoCulinariaTrimestre,
            'beneficiariosDemoCuliHomem' => $this->beneficiariosDemoCuliHomem,
            'beneficiariosDemoCuliMulher' => $this->beneficiariosDemoCuliMulher,
            'anexoEvidenciaDemonsCulinaria' => $this->anexoEvidenciaDemonsCulinaria,

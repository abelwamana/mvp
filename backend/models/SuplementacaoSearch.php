...
/**
 * SuplementacaoSearch represents the model behind the search form of `backend\models\Suplementacao`.
 */
class SuplementacaoSearch extends Suplementacao
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'nSuplemVit' => $this->nSuplemVit,
            'nSuplemViTrimestre' => $this->nSuplemViTrimestre,
            'nDesparatizacao' => $this->nDesparatizacao,
            'nDesparatizacaoTrimestre' => $this->nDesparatizacaoTrimestre,

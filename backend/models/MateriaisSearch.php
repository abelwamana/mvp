...
/**
 * MateriaisSearch represents the model behind the search form of `backend\models\Materiais`.
 */
class MateriaisSearch extends Materiais
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'nFitaMUACmenor5anos' => $this->nFitaMUACmenor5anos,
            'nFitaMUACmulherGravida' => $this->nFitaMUACmulherGravida,
            'fitasPerCefalico' => $this->fitasPerCefalico,
            'balancaPediatrica' => $this->balancaPediatrica,
            'balancaAdultas' => $this->balancaAdultas,
            'altimetro' => $this->altimetro,
        ...
        $query->andFilterWhere(['like', 'entidadeRecebeuEntPub', $this->entidadeRecebeuEntPub])
            ->andFilterWhere(['like', 'equipamentoEntregue', $this->equipamentoEntregue])

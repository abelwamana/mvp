...
/**
 * RastreioSearch represents the model behind the search form of `backend\models\Rastreio`.
 */
class RastreioSearch extends Rastreio
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['Id', 'provinciaID', 'municipioID', 'comunaID', 'localidadeID', 'DAS', 'DAM', 'EDEMA', 'Saudavel', 'trimestre', 'beneficiarioCriaGrav', 'nomeGrupoID', 'userID'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'DAM' => $this->DAM,
            'EDEMA' => $this->EDEMA,
            'Saudavel' => $this->Saudavel,
            'trimestre' => $this->trimestre,
            'beneficiarioCriaGrav' => $this->beneficiarioCriaGrav,

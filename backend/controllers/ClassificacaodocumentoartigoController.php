...
use backend\models\ClassificacaodocumentoartigoSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ClassificacaodocumentoartigoController implements the CRUD actions for Classificacaodocumentoartigo model.
 */
class ClassificacaodocumentoartigoController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all Classificacaodocumentoartigo models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new ClassificacaodocumentoartigoSearch();
    ...
    /**
     * Displays a single Classificacaodocumentoartigo model.
     * @param int $Id ID
     * @return string
    ...
    /**
     * Creates a new Classificacaodocumentoartigo model.
   ...
   public function actionCreate() {
    ...
    public function actionUpdate($Id) {
        ...
        if ($this->request->isPost && $models->load($this->request->post())) {
            // Salva o modelo se ele for válido
            if ($models->validate()) {
                $models->save();
                return $this->redirect(['view', 'Id' => $models->Id]);
            } else {
                // Lidar com erros de validação do modelo $model
                \Yii::$app->session->setFlash('error', 'Erro de validação. Verifique os campos do formulário.');
            }
        }

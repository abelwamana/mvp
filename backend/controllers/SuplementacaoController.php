...
use backend\models\SuplementacaoSearch;
...
/**
 * SuplementacaoController implements the CRUD actions for Suplementacao model.
 */
class SuplementacaoController extends Controller
{
    ...
    /**
     * Lists all Suplementacao models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new SuplementacaoSearch();
    ...
    /**
     * Displays a single Suplementacao model.
     * @param int $Id ID
     * @return string
    ...
    /**
     * Creates a new Suplementacao model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate() {
        $models = new Suplementacao();
    ...
    /**
     * Finds the Suplementacao model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $Id ID
     * @return Suplementacao the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($Id)
    {
        if (($model = Suplementacao::findOne(['Id' => $Id])) !== null) {
            return $model;
        }

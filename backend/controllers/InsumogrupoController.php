...
use backend\models\InsumogrupoSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * InsumogrupoController implements the CRUD actions for Insumogrupo model.
 */
class InsumogrupoController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all Insumogrupo models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new InsumogrupoSearch();
    ...
    /**
     * Displays a single Insumogrupo model.
     * @param int $Id ID
     * @return string
    ...
    /**
     * Creates a new Insumogrupo model.

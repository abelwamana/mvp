...
//        $model->participantes = $participantesString;
        ...
        if ($isAdmin || ($nomeLogado == $model->convocadoPor)) {
            ...
            if ($this->request->isPost && $model->load($this->request->post())) {
                ...
                $model->listaConvidados = UploadedFile::getInstance($model, 'listaConvidados');
                $model->pada = UploadedFile::getInstance($model, 'pada');
                ...
                $model->outrosAnexos = UploadedFile::getInstances($model, 'outrosAnexos');

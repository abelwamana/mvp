        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['logout', 'index', 'folhatrimestral', 'exportfolhatrimestral', 'calendario', 'fresan', 'beneficiario', 'galeria', 'get-events', 'filtragem', 'duracao', 'get-provincias', 'experiencia', 'get-municipios', 'get-comunas', 'events-area', 'add-events', 'emconstrucao', 'fresancunene', 'fresanhuila', 'fresannamibe', 'resultadosagricultura', 'resultadosnutricao', 'resultadosagua', 'resultadosreforcoinstitucional', 'edit-event', 'delete-event', 'update-event', 'update', 'contact-list'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
        ...
        if (Yii::$app->request->post('Event')) {
            ...
            if ($eventData !== null) {
                ...
                if ($calendarEvento->uploadFiles()) {
                    if ($calendarEvento->save()) { // Usar save(false) para ignorar validações temporariamente
                        $signature = "

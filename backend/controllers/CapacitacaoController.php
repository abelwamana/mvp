...
use backend\models\CapacitacaoSearch;
...
/**
 * CapacitacaoController implements the CRUD actions for Capacitacao model.
 */
class CapacitacaoController extends Controller
{
    ...
    /**
     * Lists all Capacitacao models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new CapacitacaoSearch();
    ...
    /**
     * Displays a single Capacitacao model.
     * @param int $Id ID
     * @return string
    ...
    /**
     * Creates a new Capacitacao model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
      public function actionCreate() {
        $models = new Capacitacao();
    ...
    /**
     * Finds the Capacitacao model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $Id ID
     * @return Capacitacao the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($Id)
    {
        if (($model = Capacitacao::findOne(['Id' => $Id])) !== null) {
            return $model;
        }

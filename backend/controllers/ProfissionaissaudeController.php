...
use backend\models\Profissionaissaude;
use backend\models\ProfissionaissaudeSearch;
...
/**
 * ProfissionaissaudeController implements the CRUD actions for Profissionaissaude model.
 */
class ProfissionaissaudeController extends Controller {
    ...
    /**
     * Lists all Profissionaissaude models.
     *
     * @return string
     */
    public function actionIndex() {
        $searchModel = new ProfissionaissaudeSearch();
    ...
    /**
     * Displays a single Profissionaissaude model.
     * @param int $Id ID
     * @return string
    ...
    /**
      ...
      /**
     * Finds the Profissionaissaude model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $Id ID
     * @return Profissionaissaude the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($Id) {
        if (($model = Profissionaissaude::findOne(['Id' => $Id])) !== null) {
            return $model;
        }
    ...
    public function actionPublicar($id) {
        ...
        if ($isAdmin) {
            ...
            $this->publicacarAcoes($model);// chama o metodo para alterar o estado da publicacao
        } else {
            // Verifica se o usuário logado tem a mesma entidade que a do registro
            if ($model->entidade !== $user->entidade) {
                // Redireciona ou exibe uma mensagem de erro, dependendo do seu caso

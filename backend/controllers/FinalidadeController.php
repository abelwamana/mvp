...
use backend\models\FinalidadeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * FinalidadeController implements the CRUD actions for Finalidade model.
 */
class FinalidadeController extends Controller
{
    ...
    /**
     * Lists all Finalidade models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new FinalidadeSearch();
    ...
    /**
     * Displays a single Finalidade model.
     * @param int $Id ID
     * @return string
    ...
    /**
     * Creates a new Finalidade model.

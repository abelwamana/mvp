...
use backend\models\Rastreio;
use backend\models\RastreioSearch;
...
/**
 * RastreioController implements the CRUD actions for Rastreio model.
 */
class RastreioController extends Controller {
    ...
    /**
     * Lists all Rastreio models.
     *
     * @return string
     */
    public function actionIndex() {
        $searchModel = new RastreioSearch();
    ...
    /**
     * Displays a single Rastreio model.
     * @param int $Id ID
     * @return string
    ...
    /**
     * Finds the Rastreio model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $Id ID
     * @return Rastreio the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($Id) {
        if (($model = Rastreio::findOne(['Id' => $Id])) !== null) {
            return $model;
        }

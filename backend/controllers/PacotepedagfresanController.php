...
use backend\models\PacotepedagfresanSearch;
...
/**
 * PacotepedagfresanController implements the CRUD actions for Pacotepedagfresan model.
 */
class PacotepedagfresanController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all Pacotepedagfresan models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new PacotepedagfresanSearch();
    ...
    /**
     * Displays a single Pacotepedagfresan model.
     * @param int $Id ID
     * @return string
    ...
    /**
     * Finds the Pacotepedagfresan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $Id ID
     * @return Pacotepedagfresan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($Id)
    {
        if (($model = Pacotepedagfresan::findOne(['Id' => $Id])) !== null) {
            return $model;
        }
      ...
      public static function getEnumValues($attribute) {
        $values = \Yii::$app->db->createCommand("SHOW COLUMNS FROM {{%pacotepedagfresan}} LIKE '{$attribute}'")->queryOne();

...
use backend\models\SupervisaoSearch;
...
/**
 * SupervisaoController implements the CRUD actions for Supervisao model.
 */
class SupervisaoController extends Controller
{
    ...
    /**
     * Lists all Supervisao models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new SupervisaoSearch();
    ...
    /**
     * Displays a single Supervisao model.
     * @param int $Id ID
     * @return string
    ...
    /**
     * Creates a new Supervisao model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
     public function actionCreate() {
        $models = new Supervisao();
    ...
    /**
     * Finds the Supervisao model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $Id ID
     * @return Supervisao the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($Id)
    {
        if (($model = Supervisao::findOne(['Id' => $Id])) !== null) {
            return $model;
        }

...
<nav class="main-header navbar navbar-expand navbar-white navbar-light"> <!--style="width: 83vw;"-->
    ...
    <!-- Right navbar links -->
    <ul class="navbar-nav ml-auto" style="margin-left:35.7% !important;">
        <!-- User Image -->
        <!--        <li class="nav-item align-items-right">
                    <div class="image">
                        <img style="width: 20%; height: 24%; text-align: left" src="images/userGeral.png" class="img-circle elevation-2" >
                    </div>
                </li>-->
        ...
        <li class="nav-item">
            ...
            <div class="info d-flex align-items-left">
                <div class="info d-flex align-items-right">
                    <img style="width: 20%; height: 24%; text-align: left" src="images/userGeral.png" class="img-circle elevation-2" >
                </div>
                <div class="info d-flex align-items-right">
                    <b style="color: #888C00 !important;"><?php echo strtoupper(\Yii::$app->user->identity->username); ?> | <?php echo \Yii::$app->user->identity->entidade; ?></b>
                </div>

...
//$menuItems[] =  ['label' => 'Resultados Secundários', 'url' => ['/monitoria/index2']];
            ...
            $menuItems[] = ['label' => 'Recomendações', 'url' => ['site/recomendacoes']];
            $menuItems[] = ['label' => 'Boas Práticas', 'url' => ['site/boaspraticas']];
                ...
                if (in_array($usuarioAtual, $usuariosPermitidos)) {
                    $menuItems[] = [
                        ...
                        'items' => [
                            ...
                            ['label' => 'Boas Práticas', 'url' => ['boaspraticas/boaspraticas']],
                            ['label' => 'Boas Práticas (Admin)', 'url' => ['boaspraticas/index']]
                        ],
                    ];
                }
                $menuItems[] = [

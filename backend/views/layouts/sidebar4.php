...
<aside class="main-sidebar elevation-4" style="background-color: whitesmoke;">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2 teste">
            ...
            $coberturaAtivo = (Yii::$app->controller->id === 'site' && Yii::$app->controller->action->id === 'fresan');

            // Inicie uma lista de itens de menu
            $menuItems = [
                // Primeiros itens do menu
                ['label' => 'Resultados Principais', 'url' => ['/site/index']],
                    // ['label' => 'Resultados Secundários', 'url' => ['/Monitoria/index2']],
            ];
            $menuItems = [
                ['label' => 'Cobertura','url' => ['/site/fresan'], 'iconStyle' => 'far'],
                        ['label' => 'Cunene', 'url' => ['/site/fresancunene'], 'iconStyle' => 'far'],
                        ['label' => 'Huíla', 'url' => ['/site/fresanhuila'], 'iconStyle' => 'far'],
                        ['label' => 'Namibe', 'url' => ['/site/fresannamibe'], 'iconStyle' => 'far'],
            ...
            // Adicione itens relacionados a cobertura/fresan se o cobertura estiver ativo
            if ($coberturaAtivo) {
...
// Agrupe os itens "Resumo Monitoria", "Resumo Recomendações" e "Resumo Boas Práticas" sob o item "Resumo"
            ...
            $menuItems[] = ['label' => 'Recomendações', 'url' => ['/biblioteca/index3']];
            $menuItems[] = ['label' => 'Boas Práticas', 'url' => ['/biblioteca/index3']];
...
// Itens de administração (se aplicável)...
    ...
    <!-- /.sidebar -->
       ...
       $menuItems = [
                ...
                ['label' => 'Quadro Lógico', 'url' => ['/site/index'], 'iconStyle' => 'far'],
                ['label' => 'Agricultura', 'url' => ['/monitoria/index2'], 'iconStyle' => 'far'],
                ['label' => 'Nutrição', 'url' => ['/monitoria/index2'], 'iconStyle' => 'far'],
                ['label' => 'Água', 'url' => ['/monitoria/index2'], 'iconStyle' => 'far'],
                ['label' => 'Reforço Institucional', 'url' => ['/monitoria/index2'], 'iconStyle' => 'far'],
            ],
        ],
           ];
    $menuItems = [
        ...
        ['label' => 'Cobertura',
            'items' => [
                ['label' => 'Áreas Temáticas', 'url' => ['/site/fresan'], 'iconStyle' => 'far'],
                ['label' => 'Cunene', 'url' => ['/site/fresancunene'], 'iconStyle' => 'far'],
                ['label' => 'Huíla', 'url' => ['/site/fresanhuila'], 'iconStyle' => 'far'],
                ['label' => 'Namibe', 'url' => ['/site/fresannamibe'], 'iconStyle' => 'far'],
            ],
    ...
    $menuItems = [         
        ...
        ['label' => 'Resultados', 'url' => ['/site/index'],];
       $menuItems = [

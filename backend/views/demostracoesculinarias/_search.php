...
/** @var backend\models\DemostracoesculinariasSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="demostracoesculinarias-search">
    ...
    <?php // echo $form->field($model, 'nDemostracaoCulinaria') ?>

    <?php // echo $form->field($model, 'nDemostracaoCulinariaTrimestre') ?>

    <?php // echo $form->field($model, 'beneficiariosDemoCuliHomem') ?>

    <?php // echo $form->field($model, 'beneficiariosDemoCuliMulher') ?>

    <?php // echo $form->field($model, 'anexoEvidenciaDemonsCulinaria') ?>

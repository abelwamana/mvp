...
/** @var backend\models\DemostracoesculinariasSearch $searchModel */
...
/** @var 1 Timóteo 1:15 */
//$this->title = Yii::t('app', 'Demostrações Culinárias');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="demostracoesculinarias-index">
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'nDemostracaoCulinaria',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'nDemostracaoCulinariaTrimestre',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'beneficiariosDemoCuliHomem',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'beneficiariosDemoCuliMulher',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
        'attribute' => 'anexoEvidenciaDemonsCulinaria',
        'vAlign' => 'middle',
        'hAlign' => 'center',
...
GridView::widget([
    ...
    'toolbar' => [
        [
            ...
            Html::a('<i class="fas fa-plus"></i>', ['create'], [
                ...
                'title' => 'Adicionar Demostrações Culinárias',
            ]) . ' ' .
    ...
    'panel' => [
        'heading' => Yii::t('app', 'Demostrações Culinárias'),
        'type' => '',
        'before' => '<div class="btn-group">' .
        //Html::a(Yii::t('app', 'Criar demostracoesculinarias'), ['create'], ['class' => 'btn btn-danger']).
    ...
    'itemLabelSingle' => 'Dem_Culinarias',
    'itemLabelPlural' => 'Dem_Culinarias',
]);
?>

...
/** @var backend\models\ProfissionaissaudeSearch $searchModel */
...
/** @var 1 Timóteo 1:15 */
//$this->title = Yii::t('app', 'Profissionaissaudes');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="profissionaissaude-index">
...
<?php // echo $this->render('_search', ['model' => $searchModel]);  ?>
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'NSessoesTrimestre',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'ParticipantesTrimHomem',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'ParticipantesTrimMulher',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
    ...
    GridView::widget([
        ...
        'toolbar' => [
            [
                ...
                Html::a('<i class="fas fa-plus"></i>', ['create'], [
                    ...
                    'title' => 'Adicionar Profissionais Saúde',
                ]) . ' ' .
        ...
        'panel' => [
            'heading' => Yii::t('app', 'Profissionais Saúde'),
            'type' => '',
            'before' => '<div class="btn-group">' .
            //Html::a(Yii::t('app', 'Criar profissionaissaude'), ['create'], ['class' => 'btn btn-danger']).

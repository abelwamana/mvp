...
use backend\controllers\ProfissionaissaudeController;

/** @var View $this */
/** @var Profissionaissaude $model */
/** @var ActiveForm $form */
?>
            ...
            'steps' => [
                [
                    ...
                    'fieldConfig' => [
                        ...
                        'only' => ['provinciaID', 'municipioID', 'comunaID', 'localidadeID', 'nomeFormacao', 'NTotHoras', 'NSessoes',
                            'NSessoesTrimestre', 'ParticipantesTrimHomem', 'ParticipantesTrimMulher', 'anexo', 'primeiroReporte', 'actualizacao',
                            'latitude', 'longitude', 'desafiosImplementacaoONG', 'licoesImplementacaoONG', 'dataVisitaFresan',
                            'tecnicoResponsavelFresan', 'constatacoesFeitasFresan', 'recomendacoesPrincipaisFresan', 'medidasMitigacaoONG', 'medidasMitigacaoEstado',

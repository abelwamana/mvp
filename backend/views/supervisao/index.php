...
/** @var backend\models\SupervisaoSearch $searchModel */
...
/** @var 1 Timóteo 1:15 */
//$this->title = Yii::t('app', 'Supervisaos');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="supervisao-index">
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'supervisionadoNome',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'qtdSupervisionadoTrimestre',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'supervisionadoTrimestre',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'profissionaisSupervisionadoHomem',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'profissionaisSupervisionadoMulher',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
...
GridView::widget([
    ...
    'panel' => [
        'heading' => Yii::t('app', 'Supervisão'),
        'type' => '',
        'before' => '<div class="btn-group">' .
        //Html::a(Yii::t('app', 'Criar supervisao'), ['create'], ['class' => 'btn btn-danger']).

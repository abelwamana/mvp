...
/** @var backend\models\SupervisaoSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="supervisao-search">
    ...
    <?php // echo $form->field($model, 'supervisionadoNome') ?>

    <?php // echo $form->field($model, 'qtdSupervisionadoTrimestre') ?>

    <?php // echo $form->field($model, 'supervisionadoTrimestre') ?>

    <?php // echo $form->field($model, 'profissionaisSupervisionadoHomem') ?>

    <?php // echo $form->field($model, 'profissionaisSupervisionadoMulher') ?>

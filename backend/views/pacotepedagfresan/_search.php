...
/** @var backend\models\PacotepedagfresanSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="pacotepedagfresan-search">
    ...
    <?php // echo $form->field($model, 'receitaMwangole') ?>

    <?php // echo $form->field($model, 'painelAlimentacao') ?>

    <?php // echo $form->field($model, 'outroManualAlimentacao') ?>

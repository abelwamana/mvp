...
/** @var backend\models\ArquivoSearch $searchModel */
...
<div class="arquivo-index">
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'biblioteca',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => false,
        ],
        [
            'attribute' => 'meio_de_verificacao',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => false,
        ],
...
//        ]
    ...
    GridView::widget([
        ...
        'panel' => [
            'heading' => Yii::t('app', 'arquivo'),
            'type' => '',
            'before' => '<div class="btn-group">' .
            //Html::a(Yii::t('app', 'Criar arquivo'), ['create'], ['class' => 'btn btn-danger']).

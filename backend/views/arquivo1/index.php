    ...
    <div class="view-toggle">
        ...
        <div class="navigation-bar">
            ...
            <div class="current-path">
                <span id="current-path"><?= isset($parentPath) ? Html::encode($parentPath) : '' ?></span>
            </div>
        </div>
...
// Função para carregar subpastas via AJAX
    ...
    $(document).on('click', '.icon-view .folder', function () {
        ...
        // Verifica se está na pasta raiz
        if (fullPath === 'arquivos') {
            $('#current-path').text(''); // Deixa o caminho vazio se for a raiz
        } else {

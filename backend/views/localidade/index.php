...
/** @var backend\models\LocalidadeSearch $searchModel */
...
<?php // echo $this->render('_search', ['model' => $searchModel]);  ?>
    ...
    GridView::widget([
        ...
        'panel' => [
            'heading' => Yii::t('app', 'localidade'),
            'type' => '',
            'before' => '<div class="btn-group">' .
            //Html::a(Yii::t('app', 'Criar localidade'), ['create'], ['class' => 'btn btn-danger']).
        ...
        'itemLabelSingle' => 'localidade',
        'itemLabelPlural' => 'localidades',
    ]);
    ?>

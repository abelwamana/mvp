...
/** @var backend\models\RastreioSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="rastreio-search">
    ...
    <?php // echo $form->field($model, 'DAM') ?>

    <?php // echo $form->field($model, 'EDEMA') ?>

    <?php // echo $form->field($model, 'Saudavel') ?>

    <?php // echo $form->field($model, 'trimestre') ?>

    <?php // echo $form->field($model, 'anexo') ?>

    <?php // echo $form->field($model, 'beneficiarioCriaGrav') ?>

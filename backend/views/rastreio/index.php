...
/** @var backend\models\RastreioSearch $searchModel */
...
/** @var 1 Timóteo 1:15 */
//$this->title = Yii::t('app', 'Rastreios');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="rastreio-index">
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'beneficiarioCriaGrav',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
...
GridView::widget([
    ...
    'panel' => [
        'heading' => Yii::t('app', 'Rastreio'),
        'type' => '',
        'before' => '<div class="btn-group">' .
        //Html::a(Yii::t('app', 'Criar rastreio'), ['create'], ['class' => 'btn btn-danger']).

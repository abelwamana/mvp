...
/** @var backend\models\ClassificacaodocumentoartigoSearch $searchModel */
...
?>
<div class="classificacaodocumentoartigo-index">
...
<?php // echo $this->render('_search', ['model' => $searchModel]);  ?>
    ...
    GridView::widget([
        ...
        'toolbar' => [
            [
                ...
                Html::a('<i class="fas fa-plus"></i>', ['create'], [
                    ...
                    'title' => 'Adicionar classificacaodocumentoartigo',
                ]) . ' ' .
        ...
        'panel' => [
            'heading' => Yii::t('app', 'Classificação Documento / Artigo'),
            'type' => '',
            'before' => '<div class="btn-group">' .
            //Html::a(Yii::t('app', 'Criar classificacaodocumentoartigo'), ['create'], ['class' => 'btn btn-danger']).

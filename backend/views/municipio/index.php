...
/** @var backend\models\MunicipioSearch $searchModel */
...
<div class="municipio-index">
    ...
    GridView::widget([
        ...
        'panel' => [
            'heading' => Yii::t('app', 'municipio'),
            'type' => '',
            'before' => '<div class="btn-group">' .
            //Html::a(Yii::t('app', 'Criar municipio'), ['create'], ['class' => 'btn btn-danger']).
        ...
        'itemLabelSingle' => 'município',
        'itemLabelPlural' => 'municípios',
    ]);
    ?>

...
/** @var backend\models\SuplementacaoSearch $searchModel */
...
/** @var 1 Timóteo 1:15 */
//$this->title = Yii::t('app', 'Suplementacaos');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="suplementacao-index">
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'nSuplemVit',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'nSuplemViTrimestre',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'nDesparatizacao',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'nDesparatizacaoTrimestre',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
...
GridView::widget([
    ...
    'panel' => [
        'heading' => Yii::t('app', 'Suplementação'),
        'type' => '',
        'before' => '<div class="btn-group">' .
        //Html::a(Yii::t('app', 'Criar suplementacao'), ['create'], ['class' => 'btn btn-danger']).
    ...
    'itemLabelSingle' => 'Supl',
    'itemLabelPlural' => 'Supl',
]);
?>

...
/** @var backend\models\SuplementacaoSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="suplementacao-search">
    ...
    <?php // echo $form->field($model, 'nSuplemVit') ?>

    <?php // echo $form->field($model, 'nSuplemViTrimestre') ?>

    <?php // echo $form->field($model, 'nDesparatizacao') ?>

    <?php // echo $form->field($model, 'nDesparatizacaoTrimestre') ?>

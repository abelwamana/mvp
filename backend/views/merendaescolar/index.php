...
/** @var backend\models\MerendaescolarSearch $searchModel */
...
/** @var 1 Timóteo 1:15 */
//$this->title = Yii::t('app', 'Merendaescolars');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="merendaescolar-index">
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'nTotalCestas',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'nTotalCestasTrimestre',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'nomeEscolaMerendaEscolar',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'nMeredendaEscolarHomem',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'nMeredendaEscolarMulher',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'anexoTermoEntregaMerendaEscolar',
            'vAlign' => 'middle',
            'hAlign' => 'center',
    ...
    GridView::widget([
        ...
        'toolbar' => [
            [
                ...
                Html::a('<i class="fas fa-plus"></i>', ['create'], [
                    ...
                    'title' => 'Adicionar Merenda Escolar',
                ]) . ' ' .
        ...
        'panel' => [
            'heading' => Yii::t('app', 'Merenda Escolar'),
            'type' => '',
            'before' => '<div class="btn-group">' .
            //Html::a(Yii::t('app', 'Criar merendaescolar'), ['create'], ['class' => 'btn btn-danger']).

...
<?php // echo $this->render('_search', ['model' => $searchModel]);  ?>
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'entidadeOrganizadora',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => false,
        ],
        [
            'attribute' => 'convocadoPor',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => false,
        ],
...
//        ]
    ...
    GridView::widget([
        ...
        'panel' => [
            'heading' => Yii::t('app', 'event'),
            'type' => '',
            'before' => '<div class="btn-group">' .
            //Html::a(Yii::t('app', 'Criar event'), ['create'], ['class' => 'btn btn-danger']).

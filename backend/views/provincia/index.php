...
/** @var backend\models\ProvinciaSearch $searchModel */
...
[
  ...
  'hidden'=> false,
    ...
    ; ?>
        ...
        'panel' => [
        'heading' => Yii::t('app', 'provincia'),
        'type' => '',
        'before' => '<div class="btn-group">' .
            //Html::a(Yii::t('app', 'Criar provincia'), ['create'], ['class' => 'btn btn-danger']).
        ...
        'itemLabelSingle' => 'província',
        'itemLabelPlural' => 'províncias',
        ]);
        ?>

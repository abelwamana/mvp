...
/** @var backend\models\UnidadeSearch $searchModel */
...
<?php // echo $this->render('_search', ['model' => $searchModel]);  ?>
    ...
    GridView::widget([
        ...
        'panel' => [
            'heading' => Yii::t('app', 'Unidade'),
            'type' => '',
            'before' => '<div class="btn-group">' .
            //Html::a(Yii::t('app', 'Criar unidade'), ['create'], ['class' => 'btn btn-danger']).

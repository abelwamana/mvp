...
use backend\controllers\MateriaisController;
            ...
            'steps' => [
                [
                    ...
                    'fieldConfig' => [
                        ...
                        'entidadeRecebeuEntPub' => [
                            'containerOptions' => [
                                'class' => 'form-group'
                            ],
                            'options' => [
                                'type' => 'dropdown',
                                'itemsList' => MateriaisController::getEnumValues('entidadeRecebeuEntPub'),
                        ...
                        'only' => ['provinciaID', 'municipioID', 'comunaID', 'localidadeID', 'entidadeRecebeuEntPub', 'equipamentoEntregue', 
                            'qtdEquipEntregues', 'nFitaMUACmenor5anos', 'nFitaMUACmulherGravida', 'fitasPerCefalico', 'balancaPediatrica', 
                            'balancaAdultas', 'altimetro', 'primeiroReporte', 'actualizacao', 'latitude', 'longitude',
                            'desafiosImplementacaoONG', 'licoesImplementacaoONG', 'dataVisitaFresan', 'tecnicoResponsavelFresan', 'constatacoesFeitasFresan',
                            'recomendacoesPrincipaisFresan', 'medidasMitigacaoONG', 'medidasMitigacaoEstado', 

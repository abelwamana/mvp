...
/** @var backend\models\MateriaisSearch $searchModel */
...
/** @var 1 Timóteo 1:15 */
//$this->title = Yii::t('app', 'Materiais');
...
<div class="materiais-index">
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'entidadeRecebeuEntPub',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => false,
        ],
        [
            'attribute' => 'equipamentoEntregue',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        ...
        [
            'attribute' => 'nFitaMUACmenor5anos',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'nFitaMUACmulherGravida',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'fitasPerCefalico',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'balancaPediatrica',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'balancaAdultas',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
...
GridView::widget([
    ...
    'panel' => [
        'heading' => Yii::t('app', 'Materiais'),
        'type' => '',
        'before' => '<div class="btn-group">' .
        //Html::a(Yii::t('app', 'Criar materiais'), ['create'], ['class' => 'btn btn-danger']).

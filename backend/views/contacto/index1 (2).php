...
//            ],
        ...
        'filter' => '<div class="custom-search-wrapper">
                    ...
                    <input type="text" name="SearchModel[usuario]" class="form-control custom-search-input" placeholder="Pesquisar">
                 </div>',
        ],
        [
        'attribute' => 'nome',
...
//                    'contentOptions' => ['style' => 'white-space: nowrap;'], // Evita quebra de linha
    ...
    'value' => function ($model) {
        return $model->provinciaID === 88 ? '' : $model->provincia->nomeProvincia;
    },
...
[
    ...
    'hAlign' => 'center',
    'value' => function ($model) {
        return $model->municipioID === 88 ? '' : $model->municipio->nomeMunicipio;
    },
...
[
    ...
    'hAlign' => 'center',
    'value' => function ($model) {
        return $model->comunaID === 88 ? '' : $model->comuna->nomeComuna;
    },

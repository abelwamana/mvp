...
<!--Grafico Beneficiarios de Transferencias Socias-->
<script type="text/javascript">
    google.charts.load("current", {packages: ["corechart"]});
    google.charts.setOnLoadCallback(drawChart);
...
<!--Grafico Pequenas Infraestruturas de Irrigação-->
<script type="text/javascript">
    google.charts.load("current", {packages: ["corechart"]});
    google.charts.setOnLoadCallback(drawChart);
...
<!--Grafico familias camponesas Apoiados-->
<script type="text/javascript">
    google.charts.load("current", {packages: ["corechart"]});
    google.charts.setOnLoadCallback(drawChart);
...
<!--Grafico Camponeses masculino e femi-->
<script type="text/javascript">
    google.charts.load('current', {'packages': ['corechart']});
...
<?= Html::a('Baixar Resultado', ['site/exportfolhatrimestral'], ['class' => 'btn btn-primary']) ?>
<div class="container mt-5">
    <h1 class="text-center" style="font-size: 40px; color: #919733;">Filtros / Pesquisa</h1>
    <?php
    ActiveForm::begin([
        'method' => 'get',
        'action' => Url::to(['site/folhatrimestral'])
    ]);
    ?>
    <div class="form-row">
        <div class="form-group col-md-1">
            <label for="quarter">Ano:</label>
        ...
        <div class="form-group col-md-2">
            ...
            <select class="form-control" id="provincia" name="provincia">
                ...
                <?php foreach ($provincias as $prov) : ?>
                    <option value="<?= $prov->Id ?>"><?= $prov->nomeProvincia ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="form-group col-md-2">
            ...
            <select class="form-control" id="municipio" name="municipio">
                ...
                <?php foreach ($municipios as $mun) : ?>
                    <option value="<?= $mun->Id ?>"><?= $mun->nomeMunicipio ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="form-group col-md-2">
            ...
            <select class="form-control" id="localidade" name="localidade">
                ...
                <?php foreach ($localidades as $localidade) : ?>
                    <option value="<?= $localidade->Id ?>"><?= $localidade->nomeLocalidade ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="form-group col-md-2">

...
/** @var backend\models\EventosSearch $searchModel */
...
<div class="eventos-index">
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'descricaoTema',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'estadoDescricao',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        ...
        [
            'attribute' => 'dataRelacionadaEstadForum',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => true,
        ],
        [
            'attribute' => 'tematicaAbordada',
            'vAlign' => 'middle',
            'hAlign' => 'center',
            'hidden' => false,
        ],
...
GridView::widget([
    ...
    'panel' => [
        'heading' => Yii::t('app', 'eventos'),
        'type' => '',
        'before' => '<div class="btn-group">' .
        //Html::a(Yii::t('app', 'Criar eventos'), ['create'], ['class' => 'btn btn-danger']).

...
class AguaSearch extends Agua {
    ...
    public function search($params) {
        ...
        // Adicione a condição de pesquisa para o campo 'nomeGrupo' do modelo relacionado 'grupo'

                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <nav class="menu2">
                                ...
                                <!--Código para pesquisa interna pelo buscador do google-->
                                <script async src="https://cse.google.com/cse.js?cx=96011e60715304fcd">
                                </script>
                                <div class="gcse-search"></div>
                                <!--                                <form class="search-form2" action="search-results.php" method="get">
                                                                    <label for="keyword">Pesquisar:</label>
                                                                    <input type="text" name="keyword" id="keyword" placeholder="Digite sua pesquisa aqui...">
                                                                    <button type="submit">Pesquisar</button>
                                                                </form>-->


                                <!--                                <form class="search-form2" action="search-results.php" method="get">
                                                                    <input type="text" name="keyword" placeholder="Digite sua pesquisa aqui...">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <p style="font-size: 10px; text-align: justify; line-height: 13px;">
                            ...
                            &copy; 2023 SGI FRESAN |<a title="Site Oficial do Instituto de Camões" href="https://www.instituto-camoes.pt/" target="_blank" style="text-decoration: underline; color: darkblue;">Camões, I.P.</a><br><br><a title="Site Oficial do Instituto de Camões" href="?r=site/politica" style="text-decoration: underline; color: darkblue;">Política de Privacidade</a></p>
                    </div>

                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-right" style="padding: 20px 20px 20px 20px;">
                                <button class="subscribe-btn" style="margin-left: 21%; margin-top: 4.4%;" id="subscribe-btn"><b>SUBSCREVER NEWSLATTER</b></button>
                        ...
                        <div class="col-md-12">
                            ...
                            <nav class="menu2">
                                <ul class="active">
                                    ...
                                    <?php endforeach; ?> 
                                        <button class="subscribe-btn" style="margin-right: -21%; margin-top: 1.4%;" id="subscribe-btn"><b>SUBSCREVER NEWSLATTER</b>
                                </ul>

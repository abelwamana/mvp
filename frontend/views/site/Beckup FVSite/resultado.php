...
<div class="container">
                <br><br><h3 class="section-sub-title" style="text-align: center !important;">Principais Resultados FRESAN | Camões, I.P.</h3>
                </div>
...
<section class="container" style="background-color: whitesmoke;">
                    <div class="row" style="margin-top: -100px;"> 
                              <div class="col-xl-4 col-lg-6 col-md-7 evento"><br>
                                            ...
                                            <div class="col-xl-4 col-lg-6 col-md-7 evento"><br>
                                                  <br>
                                                  <img style="width: 19.7%;" src="images/resultado/iconografia indicadores-26.png"><b style="color: darkblue; font-size: 23px;">&nbsp;371 de 500</b><p style="color: darkblue;">pequenas infraestruturas hidráulicas construídas ou reabilitadas</p>
                                              ...
                                              <div class="col-xl-4 col-lg-6 col-md-7 evento"><br>
                                                <br>
                                                <img style="width: 28.2%;" src="images/resultado/consumidores.png"><b style="color: darkblue; font-size: 23px;">&nbsp;153.873 de 180.000</b><p style="color: darkblue;">pessoas beneficiárias das pequenas infraestruturas hidráulicas</p>
                                              ...
                                              <div class="col-xl-4 col-lg-6 col-md-7 evento"><br>
                                                <br>
                                                <img style="width: 26.9%;" src="images/resultado/animal.png"><b style="color: darkblue; font-size: 23px;">&nbsp;143.721</b><p style="color: darkblue;">animais beneficiários das pequenas infraestruturas hidráulicas</p>
                                              ...
                                              <div class="col-xl-4 col-lg-6 col-md-7 evento"><br>
                                                <br>
                                                <img style="width: 24%;" src="images/resultado/hectares.png"><b style="color: darkblue; font-size: 23px;">&nbsp;84</b><p style="color: darkblue;">hectares beneficiários das pequenas infraestruturas hidráulicas</p>
                                                  <div class="bar" style="margin-top: -10px; line-height: 35px;"><div class="progressbar-text" style="color: darkblue; position: relative; right: 0px; padding: 0px; text-align: right; line-height: 0px;"><b>&nbsp;</b></div><svg viewBox="0 0 100 4" preserveAspectRatio="none" style="width: 100%; height: 100%;"><path d="M 0,2 L 100,2" stroke="#7CB9E8" stroke-width="1" fill-opacity="0"></path><path d="M 0,2 L 0,2" stroke="#7CB9E8" stroke-width="4" fill-opacity="0" style="stroke-dasharray: 100, 100; stroke-dashoffset: 0;"></path></svg></div>
                                                    <div class=" row">
                          ...
                          <img style="width: 20%;" src="images/resultado/Iconografia principal_Contratacoes.png"><b style="color: darkblue; font-size: 23px;">&nbsp;699 de 630</b><p style="color: darkblue;">agentes de extensão formados em SAN e resiliência e pecuária (ACS: 417; TG: 282)</p>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-7 evento"><br>
                              ...
                              <div class="col-xl-8 col-lg-6 col-md-7 evento">
                                    <div class=" row">
                                    <p style="text-align: right; line-height: 20px; font-size: 13px"><br><br><br><br><br><br><br><br><br><b>Dados referentes ao período: 2018 a Dezembro de 2023<br>Publicação de dados: Fevereiro de 2024<br>Última actualização: Fevereiro de 2024</b><br><b style="font-size: 11px; color: gray">[Fonte: SGI FRESAN | Camões, I.P.]</b></p>
                                    </div>
                              </div>
            </div>
